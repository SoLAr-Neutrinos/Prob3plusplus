...
int main(int argc, char * argv[] )
{
  ...
  if( argc >= 1 ) ssth12 = (double) atof( argv[1] );
  if( argc >= 2 ) ssth13 = (double) atof( argv[2] );
  if( argc >= 3 ) dmsq12 = (double) atof( argv[3] );
  ...
  double EnergyEdge[NBinsNadir+1];
 ...
 // flavor is default, but produced as mass states in sun
  ...
  TString FilePath = "/afs/ciemat.es/user/m/manthey/Code/LARSOFT_CYTOOLS/data/OSCILLATION/root/";
